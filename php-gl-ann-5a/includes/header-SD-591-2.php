    ...
    <div class="container  app-header" style="padding-bottom:10px">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8">
                <div class="input-group mainsearch" > <span class="input-group-btn">
                    <div class="btn-group"> <a href="#" style="background:#E2E2E2; padding-left:10px; padding-right:10px" class="btn btn-lg btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <span style="font-size:14px" id="asdf">All Categories</span> <span class="caret"></span> </a>
               ...
               <div style=" padding-top:7px" class="row hidden-xs hidden-sm">
                   ...
                   <a style="color:#FFFFFF;" href="#" id="campuses" data-type="select" data-pk="1" data-value="" data-title="Select Campus" class="editable editable-click editable-open" data-original-title="" title="">All Campuses</a> <span class="caret" style="color:#FFFFFF"></span> 
                    ...
                    <a style="color:#FFFFFF; margin-left:15px" href="#" id="roles" data-type="checklist" data-value="1,2,3" data-title="Select Role" class="editable editable-click editable-open" data-original-title="" title="">All Roles</a> <span class="caret" style="color:#FFFFFF"></span>
