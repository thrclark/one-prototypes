                    ...
                    <div class="announcement-footer">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                ...
                                <a href="SD-global-announce5-tcp.php" class="btn btn-primary btn-sm dismiss1" data-dismiss=""><i class="icon-play-circled2"></i> <span class="">Open Task Center</span></a> </div>
                        </div>
                    </div>
                </div>
            </div>
