...
<div class="modal fade" id="announcement_task" tabindex="-1" role="dialog" aria-labelledby="modalPaycheckLabel" aria-hidden="true">
                    ...
                    <div class="comment-list">
                        <ul class="list-unstyled">
                            ...
                            <li class="announcement2">
                                <div class="message">
                                    <div class="row message-header">
                                        <div class="col-xs-12 col-sm-8 message-title"> Classified Ad Expiration </div>
                                        <div class="col-xs-12 col-sm-4 message-meta"> <small class="message-date">10/21/15</small> </div>
                                    </div>
                                    <div class="message-content">
                    ...
                    <div class="announcement-footer">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                ...
                                <button type="button" class="btn btn-primary btn-sm " data-dismiss="modal"><i class="icon-play-circled2"></i> Start</button>
                            </div>
                        </div>
                    </div>
                </div>
