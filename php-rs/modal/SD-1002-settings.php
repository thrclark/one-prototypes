  ...
  top: -3px;"> <i class="icon-cancel-3"></i> <span class="sr-only" aria-hidden="true">Close preferences.</span> </button>
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="checkbox">
                                                <span class="text-muted checkboxdesc">
                                                    <input id="tasklaunch" type="checkbox">
                                                    Always open Tasks in a new window. </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="checkbox">
                                                   <span class="text-muted checkboxdesc">
                                                    ...
                                                    Don't show Featured Tasks carousel </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="checkbox">
                                                 <span class="text-muted checkboxdesc">
                                                    ...
                                                    Don't show Active Content on task tiles </span>
                                            </div>
                                        </div>
                                    </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="checkbox">
                                                 <span class="text-muted checkboxdesc">
                                                   ...
                                                   Enable category filter on search </span>
                                            </div>
                                        </div>
                                    </div>
                                      ...
                                      <div class="form-group">
                                        <label for="fluidtoggle" class="col-sm-3 control-label">Layout</label>
                                        <div class="col-sm-9">
                                            <div class="checkbox">
                                                  <span class="text-muted checkboxdesc">
                                                    <input type="checkbox" id="fluidtoggle">
                                                   Fluid Page Layout (NOTE - this is provided for convenience of demonstrating the prototypes. This control should not be allowed as a user preference) </span>
                                            </div>
                                        </div>
                                    </div>
