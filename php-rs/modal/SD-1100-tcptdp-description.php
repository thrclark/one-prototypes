...
<div class="modal fade" id="tcptdp-description" tabindex="-1" role="dialog" aria-labelledby="modalPaycheckLabel" aria-hidden="true">
    <div class="modal-dialog modal-lgg" >
        <div class="modal-content sd-modal informational">
            <div class="container-fluid ">
                <div class="row">
                    <div class="col-md-1 col-xs-height sd-modal-visual text-center"><i class="icon-info-circled-2"></i></div>
                    <div class="col-md-11 col-xs-height col-full-height sd-modal-content" style="padding-top:15px">
                        <div class="row form-group" id="feedback_block">
                            <div class="col-xs-12">
                                <h4 class="category" id="reviews">Description</h4>
