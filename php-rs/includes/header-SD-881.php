...
<header >
    <div class="container togglecontainer app-header" style="padding-bottom:10px">
        <div class="row">
            ...
            <div class="col-md-2 col-lg-2 hidden-xs hidden-sm text-right"> <a href="#" class="btn btn-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false" style=" padding-left:0px; color:#ffffff">Hi, Tom <span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="divider"></li>
                    <li><a href=""><i class="icon-logout"></i>Not Tom?</a></li>
                </ul>
                <br>
