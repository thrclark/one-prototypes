<header >
    <section style="background:#333">
        <div class="container togglecontainer app-header">
            <div class="row">
...
<section style=" background:#f8f8f8">    <div class="container navbar navbar-default hidden-sm hidden-xs" style="margin-bottom: 0; border:none">
        <div class="container">
            <ul class="nav navbar-nav">
                <li class="dropdown " id="category_select"> <a href="" class="dropdown-toggle" data-toggle="dropdown"> <span >All Categories</span> <span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
