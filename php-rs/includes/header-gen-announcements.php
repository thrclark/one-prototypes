...
<header class="">
    <div class="container app-header togglecontainer" id="contain2">
        <div class="row">
            <div class="col-xs-9 col-sm-9 col-md-3 col-lg-3 brand"> <a class="logo" href="SD-home.php" id="sidebar_logo" tabindex="0"> <img alt="clear all search filters and return to the home page" src="../img/oneiu-logo.png" class="hidden-xs hidden-sm"> <img alt="clear all search filters and return to the home page" src="../img/oneiu-logo-mobile.png" class="hidden-md hidden-lg">
                <h1><span class="sr-only">One.IU</span></h1>
                </a> </div>
            <div class="col-xs-3 col-sm-3 hidden-md hidden-lg mobile-menu">
                <div class="pull-right"> <a href="#" class="btn btn-link toggle-global-announcements" style="color:#FFFFFF; position:relative"> <i class="icon-bell-3"></i>  <span class="sr-only">Announcements</span></a>
