...
<script type='text/javascript'>
    ...
    $(window).load(function() {
        ...
        $("#hideactivecontent").click(function() {
		 ...
		 $("#fluidtoggle").click(function() {
            if ($(this).is(":checked")) {
                $( ".togglecontainer" ).removeClass( "container" );
				$( ".togglecontainer" ).addClass( "container-fluid" );
				
            } else {
                 $( ".togglecontainer" ).addClass( "container" );
				$( ".togglecontainer" ).removeClass( "container-fluid" );
            }
        });
