            ...
            <div class="col-xs-12 col-sm-12 col-md-7">
                ...
                <div style=" padding-top:7px" class="row hidden-xs hidden-sm">
                    <div class="col-xs-6"> 
                        ...
                        <!-- Single button -->
                        <div class="btn-group"> <a style=" color:#FFFFFF" href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <span id="asdf">All Categories</span> <span class="caret"></span> </a>
