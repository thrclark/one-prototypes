...
<header >
    <div class="container togglecontainer app-header" style="padding-bottom:10px">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-7 col-lg-8">
                <div class="well well-sm">
                    <div class="input-group mainsearch" >
                        <input type="text" class="form-control typeahead2 tt-query" autocomplete="off" spellcheck="false" placeholder="What would you like to do?" style="z">
            ...
            <div class="col-md-2 col-lg-2 hidden-xs hidden-sm text-right">
               
                <a href="#" class="btn btn-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false" style=" padding-left:0px; color:#ffffff">Hi, Tom <span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu">
                    <li><a href="/favorites"><i class="icon-heart"></i>My Favorites</a></li>
                    <li><a href=""><i class="icon-cog"></i>Preferences</a></li>
                    <li class="divider"></li>
                    <li><a href=""><i class="icon-cog"></i>Alerts (4)</a></li>
                    <li class="divider"></li>
                    <li><a href=""><i class="icon-comment"></i>Send Feedback</a></li>
                    <li><a href=""><i class="icon-info"></i>Help</a></li>
                    <li class="divider"></li>
                      <li><a href="SD-929a.php" onClick="alert('Local storage is NOT cleared, user is signed out')"><i class="icon-logout"></i>Sign Out</a></li>
                </ul>
