                                    ...
                                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                        <div class="panel panel-default">
                                            <div class="panel-heading" role="tab" id="heading_approveroverview">
                                                <div class="row">
                                                    <div class="col-xs-9">
                                                        <h4 class="panel-title"> <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse_approveroverview" aria-expanded="true" aria-controls="collapse_approveroverview" class="">Approver Overview</a> </h4>
                                                    </div>
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading" role="tab" id="heading_notes">
                                                <div class="row">
                                                    <div class="col-xs-9">
                                                        <h4 class="panel-title"> <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse_notes" aria-expanded="true" aria-controls="collapse_notes" class="">Notes</a> </h4>
                                                    </div>
