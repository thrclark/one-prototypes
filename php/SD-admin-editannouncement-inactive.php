            ...
            <div class="ng-view main-content">
                ...
                <form name="announcementForm" novalidate validate="errors" id="announcementForm" class="ng-pristine ng-invalid ng-invalid-required ng-valid-maxlength">
                    <fieldset>
                        ...
                        <legend> Active Dates <span class="text-muted" style="font-size:14px">(currently inactive)</span></legend>
                        <div class="row">
                    ...
                    <a href="#/tasks" ng-hide="pending" class="btn btn-danger">Remove Announcement</a> <a href="#/pendingTasks" ng-show="pending" class="btn btn-default ng-hide" aria-hidden="true">Remove</a>
                </form>
            </div>
        </div>
    </div>
...
$("#setstartdate").val(m + "/" + d + "/" + y + " at " + hour + ":" + minutes);
