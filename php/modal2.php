                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-xs-10">
                            ...
                            <div class="action text-center">
                                <button type="button" class="btn btn-sm btn-default" data-dismiss="modal">Resume Session</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-xs-10">
                            ...
                            <div class="action text-center">
                                <button type="button" class="btn btn-sm btn-default" data-dismiss="modal">Okay</button>
                            </div>
                        </div>
                    </div>
                </div>
