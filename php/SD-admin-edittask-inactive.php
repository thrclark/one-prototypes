                ...
                <form name="taskForm" novalidate validate="errors" id="taskForm" class="ng-pristine ng-valid-maxlength ng-valid-url ng-valid-pattern ng-valid-min ng-valid-max ng-valid ng-valid-required">
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="radio">
                                    <label>
                                        <input type="radio" name="setactive" value="activerange" id="active-leave" checked="checked" onclick="showHide(this)">
                                        Don't activate this task</label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="setactive" value="activeimmediate" id="active-immediate"  onclick="showHide(this)">
                                        Activate task immediately</label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="setactive" value="activefuture" id="active-future" onclick="showHide(this)">
                                        Activate task on a specified future date </label>
                                </div>
                                <div class="radio">
                                    <label>
                            ...
                            <div id="activefuture" class='hide' style="display: inline">
                                <div class="form-group col-md-3 desc" >
                                    <label for="beginDate" class="control-label">Active Date</label>
