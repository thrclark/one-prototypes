...
.modal-dialog.modal-tabs-left .modal-content .modal-body .row .tab-container {
	padding: 0px;
	background: red;
}
.modal-dialog.modal-tabs-top .modal-content .modal-body .tab-content .tab-pane {
...
.modal-dialog.modal-default.modal-tabs-left .modal-content .modal-body .row .tab-container {
	background: #2879B8;
}
    ...
    <div id="main-content">
        ...
        <div class="modal-dialog modal-default modal-tabs-left">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xs-3 tab-container"> <!-- required for floating --> 
                            <!-- Nav tabs -->
