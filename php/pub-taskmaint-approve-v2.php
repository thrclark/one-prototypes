                                    ...
                                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                        <div class="panel panel-default">
                                            <div class="panel-heading" role="tab" id="heading_approveroverview">
                                                <div class="row">
                                                    <div class="col-xs-9">
                                                        <h4 class="panel-title"> <a role="button" data-toggle="collapse" data-parent="#accordionnnn" href="#collapse_approveroverview" aria-expanded="true" aria-controls="collapse_approveroverview" class="">Approver Overview</a> </h4>
                                                    </div>
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading" role="tab" id="heading_notes">
                                                <div class="row">
                                                    <div class="col-xs-9">
                                                        <h4 class="panel-title"> <a role="button" data-toggle="collapse" data-parent="#accordionnnn" href="#collapse_notes" aria-expanded="true" aria-controls="collapse_notes" class="">Notes</a> </h4>
                                                    </div>
                                                    <div class="col-xs-3 panel-validation text-right"><span class="showerror" style=" display:none">1 error</span></div>
                                                </div>
                                            </div>
                                            <div id="collapse_notes" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_notes">
                                                <div class="panel-body">
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading" role="tab" id="heading_taskbasics">
                                                <div class="row">
                                                    <div class="col-xs-9">
                                                        <h4 class="panel-title"> <a role="button" data-toggle="collapse" data-parent="#accordionnnn" href="#collapse_taskbasics" aria-expanded="true" aria-controls="collapse_taskbasics" class="">Task Basics</a> </h4>
                                                    </div>
                                                    <div class="col-xs-3 panel-validation text-right"></div>
                                                </div>
                                            </div>
                                            <div id="collapse_taskbasics" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_taskbasics">
                                                <div class="panel-body">
                                                    ...
                                                    <hr>
                                                    <a role="button" data-toggle="collapse" data-parent="#accordionnnn" href="#collapse_description" aria-expanded="false" aria-controls="collapse_description" class="btn btn-primary btn-sm pull-right">Continue <i class="icon-down-open-1"></i></a> </div>
                                            </div>
                                        </div>
                                        <div class="panel panel-default">
                                            <div class="panel-heading" role="tab" id="heading_description">
                                                <div class="row">
                                                    <div class="col-xs-9">
                                                        <h4 class="panel-title"> <a role="button" data-toggle="collapse" data-parent="#accordionnnn" href="#collapse_description" aria-expanded="true" aria-controls="collapse_description" class="">Description</a> </h4>
                                                    </div>
                                                    <div class="col-xs-3 panel-validation text-right"></div>
                                                </div>
                                            </div>
                                            <div id="collapse_description" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_description">
                                                <div class="panel-body">
                                                    ...
                                                    <hr>
                                                    <a role="button" data-toggle="collapse" data-parent="#accordionnnn" href="#collapse_taskicon" aria-expanded="false" aria-controls="collapse_taskicon" class="btn btn-primary btn-sm pull-right">Continue <i class="icon-down-open-1"></i></a> </div>
                                            </div>
                                        </div>
                                        <div class="panel panel-default">
                                            <div class="panel-heading" role="tab" id="heading_taskicon">
                                                <div class="row">
                                                    <div class="col-xs-9">
                                                        <h4 class="panel-title"> <a role="button" data-toggle="collapse" data-parent="#accordionnnn" href="#collapse_taskicon" aria-expanded="true" aria-controls="collapse_taskicon" class="">Task Icon</a> </h4>
                                                    </div>
                                                    <div class="col-xs-3 panel-validation text-right"></div>
                                                </div>
                                            </div>
                                            <div id="collapse_taskicon" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_taskicon">
                                                <div class="panel-body">
                                                    ...
                                                    <hr>
                                                    <a role="button" data-toggle="collapse" data-parent="#accordionnnn" href="#collapse_contacts" aria-expanded="false" aria-controls="collapse_contacts" class="btn btn-primary btn-sm pull-right">Continue <i class="icon-down-open-1"></i></a> </div>
                                            </div>
                                        </div>
                                        <div class="panel panel-default">
                                            <div class="panel-heading" role="tab" id="heading_contacts">
                                                <div class="row">
                                                    <div class="col-xs-9">
                                                        <h4 class="panel-title"> <a role="button" data-toggle="collapse" data-parent="#accordionnnn" href="#collapse_contacts" aria-expanded="true" aria-controls="collapse_contacts" class="">Contacts &amp; Publisher</a> </h4>
                                                    </div>
                                                    <div class="col-xs-3 panel-validation text-right"></div>
                                                </div>
                                            </div>
                                            <div id="collapse_contacts" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_contacts">
                                                <div class="panel-body">
                                                    ...
                                                    <hr>
                                                    <a role="button" data-toggle="collapse" data-parent="#accordionnnn" href="#collapse_screenshots" aria-expanded="false" aria-controls="collapse_screenshots" class="btn btn-primary btn-sm pull-right">Continue <i class="icon-down-open-1"></i></a> </div>
                                            </div>
                                        </div>
                                        <div class="panel panel-default screenshots">
                                            <div class="panel-heading" role="tab" id="heading_screenshots">
                                                <div class="row">
                                                    <div class="col-xs-9">
                                                        <h4 class="panel-title"> <a role="button" data-toggle="collapse" data-parent="#accordionnnn" href="#collapse_screenshots" aria-expanded="true" aria-controls="collapse_screenshots" class="">Screen Shots &amp; Video</a> </h4>
                                                    </div>
                                                    <div class="col-xs-3 panel-validation text-right"></div>
                                                </div>
                                            </div>
                                            <div id="collapse_screenshots" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_screenshots">
                                                <div class="panel-body">
                                                    ...
                                                    <hr>
                                                    <a role="button" data-toggle="collapse" data-parent="#accordionnnn" href="#collapse_audience" aria-expanded="false" aria-controls="collapse_audience" class="btn btn-primary btn-sm pull-right">Continue <i class="icon-down-open-1"></i></a> </div>
                                            </div>
                                        </div>
                                        <div class="panel panel-default">
                                            <div class="panel-heading" role="tab" id="heading_audience">
                                                <div class="row">
                                                    <div class="col-xs-9">
                                                        <h4 class="panel-title"> <a role="button" data-toggle="collapse" data-parent="#accordionnnn" href="#collapse_audience" aria-expanded="true" aria-controls="collapse_audience" class="">Audience</a> </h4>
                                                    </div>
                                                    <div class="col-xs-3 panel-validation text-right"></div>
                                                </div>
                                            </div>
                                            <div id="collapse_audience" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_audience">
                                                <div class="panel-body">
                                                    ...
                                                    <hr>
                                                    <a role="button" data-toggle="collapse" data-parent="#accordionnnn" href="#collapse_authentication" aria-expanded="false" aria-controls="collapse_authentication" class="btn btn-primary btn-sm pull-right">Continue <i class="icon-down-open-1"></i></a> </div>
                                            </div>
                                        </div>
                                        <div class="panel panel-default">
                                            <div class="panel-heading" role="tab" id="heading_authentication">
                                                <div class="row">
                                                    <div class="col-xs-9">
                                                        <h4 class="panel-title"> <a role="button" data-toggle="collapse" data-parent="#accordionnnn" href="#collapse_authentication" aria-expanded="true" aria-controls="collapse_authentication" class="">Authentication <span class="small text-muted">(optional)</span></a> </h4>
                                                    </div>
                                                    <div class="col-xs-3 panel-validation text-right"></div>
                                                </div>
                                            </div>
                                            <div id="collapse_authentication" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_authentication">
                                                <div class="panel-body">
                                                    ...
                                                    <hr>
                                                    <a role="button" data-toggle="collapse" data-parent="#accordionnnn" href="#collapse_versioning" aria-expanded="false" aria-controls="collapse_versioning" class="btn btn-primary btn-sm pull-right">Continue <i class="icon-down-open-1"></i></a> </div>
                                            </div>
                                        </div>
                                        <div class="panel panel-default">
                                            <div class="panel-heading" role="tab" id="heading_versioning">
                                                <div class="row">
                                                    <div class="col-xs-9">
                                                        <h4 class="panel-title"> <a role="button" data-toggle="collapse" data-parent="#accordionnnn" href="#collapse_versioning" aria-expanded="true" aria-controls="collapse_versioning" class="">Versioning <span class="small text-muted">(optional)</span></a> </h4>
                                                    </div>
                                                    <div class="col-xs-3 panel-validation text-right"></div>
                                                </div>
                                            </div>
                                            <div id="collapse_versioning" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_versioning">
                                                <div class="panel-body">
                                                    ...
                                                    <hr>
                                                    <a role="button" data-toggle="collapse" data-parent="#accordionnnn" href="#collapse_activecontent" aria-expanded="false" aria-controls="collapse_activecontent" class="btn btn-primary btn-sm pull-right">Continue <i class="icon-down-open-1"></i></a> </div>
                                            </div>
                                        </div>
                                        <div class="panel panel-default">
                                            <div class="panel-heading" role="tab" id="heading_activecontent">
                                                <div class="row">
                                                    <div class="col-xs-9">
                                                        <h4 class="panel-title"> <a role="button" data-toggle="collapse" data-parent="#accordionnnn" href="#collapse_activecontent" aria-expanded="true" aria-controls="collapse_activecontent" class="">Active Content <span class="small text-muted">(optional)</span></a> </h4>
                                                    </div>
                                                    <div class="col-xs-3 panel-validation text-right"></div>
                                                </div>
                                            </div>
                                     ...
                                     <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="heading12">
                                            <h4 class="panel-title"> <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordionnnn" href="#collapse12" aria-expanded="false" aria-controls="collapse12"> asdfasdfasdf </a> </h4>
                                        </div>
