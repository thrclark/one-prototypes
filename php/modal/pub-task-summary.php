...
">
               ...
               <table class="table table-condensed table-comparison small">
                                                    <thead class="">
                                                        <tr>
                                                    ...
                                                    -->
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="compare-tags">
                                                            
                                                          
                                                            
                                                            <span class="label label-white"> IU Bloomington</span></td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Roles</th>
                                                            <td class="compare-tags"><span class="label label-white">All Roles</span></td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Categories</th>
                                                            <td class="compare-tags"> <span class="label label-white">Finanace</span></td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <span class="label label-white">Holds       <i class="icon-eye"></i> </span> 
                                                            <span class="label label-white">Bursar      <i class="icon-eye"></i> </span> 
                                                            <span class="label label-white">Finanace      <i class="icon-eye"></i> </span> 
