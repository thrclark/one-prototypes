...
<div class="modal fade" id="modalClassifiedsArch" tabindex="-1" role="dialog" aria-labelledby="modalPaycheckLabel" aria-hidden="true">
            ...
            <div class="container-fluid ">
                ...
                <div class="col-md-11 col-xs-height col-full-height sd-modal-content">
                    <div style=" position:relative">
                        <h4 class="category" style="border-bottom:solid 1px #ccc;  padding-top:10px; margin:0px;">Dismissed Announcements </h4>
                    </div>
