...
<div class="modal fade" id="modal_summaryupdate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <div class="modal-content">
           <div class="modal-header">
            ...
            <div class="modal-body">
               <div class="taskmaint-preview"> <img src="../img/task-icons-new/icon-classifieds.png" alt="" style="max-height: 42px;width: auto;vertical-align: text-bottom;">
                ...
                <div class="tabbable-panel">
                    <div class="tabbable-line">
                        <ul class="nav nav-tabs ">
                            <li class="active"> <a href="#tab_default_11" data-toggle="tab"> Task Updates </a> </li>
                            <li> <a href="#tab_default_22" data-toggle="tab"> Notes </a> </li>
                        </ul>
