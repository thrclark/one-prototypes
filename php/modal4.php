...
.modal-dialog.modal-tabs-top .modal-content .modal-body .nav-tabs.nav-justified> li> a {
	...
	border-radius: 0px 0px 0 0;
	    border-bottom: 1px solid #2879B8;
}
...
.modal-dialog.modal-default .modal-content .modal-body .modal-visual {
	background: #2879B8;
}
.modal-dialog.modal-warning .modal-content .modal-body .modal-visual {
	background: #C59217;
}

.modal-dialog.modal-error .modal-content .modal-body .modal-visual {
	background: #dc0031;
}


.modal-dialog.modal-success .modal-content .modal-body .modal-visual {
	background: #387f38;
}
...
.modal-dialog.modal-warning .modal-content .modal-footer {
	background: #AC7A02;
...
.modal-dialog.modal-default .modal-content .modal-body .row .col-sm-9.col-xs-10 {
    background: #0B4E83;
    color: #ffffff;
}

.modal-dialog.modal-warning .modal-content .modal-body .row .col-sm-9.col-xs-10 {
	    background: #AC7A02;
    color: #ffffff;
}
.modal-dialog.modal-error .modal-content .modal-body .row .col-sm-9.col-xs-10 {
background: #A20024;
    color: #ffffff;
}

.modal-dialog.modal-success .modal-content .modal-body .row .col-sm-9.col-xs-10 {
	background: #256625;
    color: #ffffff;
}
...
.modal-dialog.modal-default .modal-content .modal-body {
	background: #2879B8;
	color: #ffffff;
}
.modal-dialog.modal-warning .modal-content .modal-body {
	background: #C59217;
	color: #ffffff;
}
...
.modal-dialog.modal-default .modal-content .modal-body .comment-list > ul > li {
    border-bottom: solid 1px #0B4E83;
}

.modal-dialog.modal-tabs-top .modal-content .modal-body .nav-tabs.nav-justified> .active> a, 
.modal-dialog.modal-tabs-top .modal-content .modal-body .nav-tabs.nav-justified> .active> a:hover{
	border-bottom-color:#2879B8}
...
<div class="main-content container" role="main">
    <div id="main-content">
        ...
        <div class="modal-dialog modal-default">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-link" data-dismiss="modal" style="color:#FFFFFF">Close</button>
        ...
        <div class="modal-dialog modal-default modal-tabs-top">
            <div class="modal-content" style="    background-color: #2879B8;">
                <div class="modal-body">
