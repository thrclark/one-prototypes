            ...
            <ul id="menu-content" class="menu-content">
                ...
                <li data-toggle="collapse" data-target="#nav-data" class="collapsed"><a href="#">Data Settings<i class="icon-down-open-big"></i></a>
                    <ul <?php if ($section == 'data') {echo 'class="sub-menu"';} else {echo 'class="sub-menu collapse"';} ?> id="nav-data">
                        ...
                        <li <?php if ($page_title == 'xxxxxxxxxxxxxxxxx') { echo 'class="active"'; } ?>><a href="xxxxxxxxxxxxxxxxx.php">Review Replies</a></li>
                ...
                <li data-toggle="collapse" data-target="#nav-advanced" class="collapsed"><a href="#">Advanced <i class="icon-down-open-big"></i></a>
                    <ul <?php if ($section == 'advanced') {echo 'class="sub-menu"';} else {echo 'class="sub-menu collapse"';} ?> id="nav-advanced">
                        <li <?php if ($page_title == 'xxxxxxxxxxxxxxxxx') { echo 'class="active"'; } ?>><a href="xxxxxxxxxxxxxxxxx.php">Maintain Settings</a></li>
                        <li <?php if ($page_title == 'xxxxxxxxxxxxxxxxx') { echo 'class="active"'; } ?>><a href="xxxxxxxxxxxxxxxxx.php">Maintain Publishers</a></li>
                        <li <?php if ($page_title == 'xxxxxxxxxxxxxxxxx') { echo 'class="active"'; } ?>><a href="xxxxxxxxxxxxxxxxx.php">Maintain Campuses</a></li>
                        <li <?php if ($page_title == 'xxxxxxxxxxxxxxxxx') { echo 'class="active"'; } ?>><a href="xxxxxxxxxxxxxxxxx.php">Maintain Restricted Users</a></li>
                        ...
                        <li <?php if ($page_title == 'xxxxxxxxxxxxxxxxx') { echo 'class="active"'; } ?>><a href="xxxxxxxxxxxxxxxxx.php">Maintain API Accounts</a></li>
