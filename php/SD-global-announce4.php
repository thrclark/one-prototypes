            ...
            <div class="row">
                ...
                <div class="col-md-6 hidden-xs hidden-sm">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="#" class="slide-global-announcements"><i class="icon-bell-3"></i> <span class="sr-only">Notifications</span></a> </li>
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="announcement">
                        <div class="message">
                            ...
                            <div class="message-content" data-readmore="" aria-expanded="false" id="rmjs-1" style="max-height: none; height: 80px;">
                            ...
                            </div><a href="#" class="moreless" data-readmore-toggle="" aria-controls="rmjs-1">more...</a>
                            <div class="row message-footer">
                                <div class="message-footer-actions"> <a href="#" class="btn btn-link dismiss-announcement" id=""> <i class="icon-cancel-circled"></i></a> </div>
                            </div>
                        </div>
...
<script>
$( ".slide-global-announcements" ).click(function() {
  $( ".ga-slide" ).toggleClass( "open" );
});
</script>
