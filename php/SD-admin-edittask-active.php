                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6" >
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="setactive" value="activeleave" id="active-leave" checked="checked" onclick="showHide(this)">
                                        Currently active</label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="setactive" value="activeimmediate" id="active-immediate" onclick="showHide(this)">
                                        Inactivate task immediately</label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="setactive" value="activefuture" id="active-future" onclick="showHide(this)">
                                        Inactivate task on a specified future date </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="setactive" value="activerange" id="active-range" onclick="showHide(this)">
                                        Activate task for a specific date range</label>
                                </div>
                            </div>
                            <div id="activeimmediate" style="display:inline"> </div>
                            <div id="activefuture" class='hide' style="display: inline">
                                <div class="form-group col-md-3 desc" >
                                    <label for="beginDate" class="control-label">Inactive Date</label>
                            ...
                            <div id="activerange" class='hide' style="display: inline">
                                <div class="form-group col-md-3 desc" >
                            ...
                            <div class="col-md-6">     
                             ...
                             <small class="text-muted">Note - if the current date is not within this date range, your task (if currently active) will be inactivated until the beginning of the specified range.</small>
...
function showHide(elm) {
  var activeimmediate = document.getElementById("activeleave");
  var activeimmediate = document.getElementById("activeimmediate");
  var activefuture = document.getElementById("activefuture");
  var activerange = document.getElementById("activerange")
  if (elm.id == 'active-immediate') {
    activeimmediate.classList.remove('hide');
    activefuture.classList.add('hide');
	activerange.classList.add('hide');
  } else {
    
  };
  
   if (elm.id == 'active-future') {
    activeimmediate.classList.add('hide');
    activefuture.classList.remove('hide');
	activerange.classList.add('hide');
  } else {
   ...
   if (elm.id == 'active-range') {
    activeimmediate.classList.add('hide');
    activefuture.classList.add('hide');
	activerange.classList.remove('hide');
  } else {
    
  };
  
     if (elm.id == 'active-leave') {
    activeimmediate.classList.add('hide');
    activefuture.classList.add('hide');
	activerange.classList.add('hide');
  } else {
