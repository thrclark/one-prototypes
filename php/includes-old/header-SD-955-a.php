            ...
            <div class="col-xs-12 col-md-9 col-lg-9 search">
                <div class="well well-sm">
                    <form class="input-group mainsearch">
                        ...
                        <div class="input-group-btn" style="display:none" id="categoryfilter"> <a href="#" style="  margin-right: -2px;" class="btn btn-lg btn-default dropdown-toggle catfilter" data-toggle="dropdown" aria-expanded="false"> <span style="font-size:14px" id="asdf" class="hidden-xs hidden-sm">All Categories</span> <span class="caret"></span> </a>
                        ...
                        <div class="col-xs-8 text-right">
                            ...
                            <div class="dropdown" id="role_select" aria-hidden="false"> <a href="" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"> <span class="">All Roles</span><span class="caret"></span> </a>
                                <ul class="dropdown-menu dropdown-menu-right checked-list" role="menu">
                                    <li role="menuitem" class=""> <a href="#" tabindex="0"> <i role="presentation" class="pull-right icon-ok ng-hide" aria-hidden="true"></i> <span>Delete Me</span> </a> </li>
                                    ...
                                    <li role="menuitem" class=""> <a href="#" tabindex="0"> <i role="presentation" class="pull-right icon-ok ng-hide" aria-hidden="true"></i> <span>Faculty2</span> </a> </li>
                                    <li role="menuitem" class=""> <a href="#" tabindex="0"> <i role="presentation" class="pull-right icon-ok ng-hide" aria-hidden="true"></i> <span>role that overlaps checkmark</span> </a> </li>
                                    ...
                                    <li role="menuitem" class=""> <a href="#" tabindex="0"> <i role="presentation" class="pull-right icon-ok ng-hide" aria-hidden="true"></i> <span>WWWW</span> </a> </li>
                                    <li role="menuitem" class=""> <a href="#" tabindex="0"> <i role="presentation" class="pull-right icon-ok ng-hide" aria-hidden="true"></i> <span>Ὀδυσσέα Ἐλύτη</span> </a> </li>
                                </ul>
                            </div>
                        </div>
                    </div>
