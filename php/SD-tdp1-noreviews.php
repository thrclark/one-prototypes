    ...
    <div id="main-content">
        <div class="tcptdp-header">
            ...
            <div class="media-body">
                ...
                <div class="controls"><a href="#" class="btn btn-default favorite notice"> <i class="icon-heart-empty"></i><i class="icon-heart" style="display:none; color:#eba2a3"></i> <span class="sr-only">Favorite</span></a> <a href="#" class="btn btn-primary" data-toggle=modal data-target="#modalClassifieds"> <i class="icon-play-circled2"></i> <span class="">Launch Task</span></a></div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-tabs nav-tabs-headers nav-tabs-responsive">
                    ...
                    <li><a href="#reviewsratings" data-toggle=tab>Ratings</a></li>
                    <li><a href="#related" data-toggle=tab>Related</a></li>
                    <li><a href="#announcements" data-toggle=tab> Announcements
                        <div class="container-badge" id="announcement-counter" style="       top: 7px;
    right: 12px;"><span class="badge">2</span></div></a></li>
                </ul>
...
<?php include('modal/announcement-archived.php') ?>
<?php include('modal/SD-1002-settings.php') ?>
<?php include('modal/rating.php') ?>
